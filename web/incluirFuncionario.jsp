...
<html lang="pt-br">
  ...
  <form action="incluir.funcionario" method="post" style="width:600px">
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="txtNome" class="form-control" id="inputAddress" placeholder="Nome"/>
  </div>

    <div class="form-group">
    <label for="inputAddress">Salário Bruto</label>
    <input type="text" name="txtSalarioBruto" class="form-control" id="inputAddress" placeholder="Salário bruto"/>
  </div>
